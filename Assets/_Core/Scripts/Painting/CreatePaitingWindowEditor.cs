...
public class CreatePaitingWindowEditor : EditorWindow
{
    ...
    [MenuItem("Tools/Create Paiting")]
    public static void ShowWindow()
    {
        GetWindow<CreatePaitingWindowEditor>("Create Paiting");
    }
    ...
    private void CreateCustomPaiting()
    {
    ...
    private void DeleteCustomPaiting(PaintingItem asset)
    {
